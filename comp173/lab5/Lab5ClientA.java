...
/**
 * java Lab5ClientA.java [portnum] [operator] [int] [int2] [int...]
 * @author Curtis LayCraft
 */
public class Lab5ClientA {
	...
	* 	comp173.lab5.Lab5ClientA localhost 12345 + 1 2 3 4 5 
	...
	*/
    public static void main(String[] args) throws IOException{
	    ...
	    Lab5ClientA client = new Lab5ClientA();
